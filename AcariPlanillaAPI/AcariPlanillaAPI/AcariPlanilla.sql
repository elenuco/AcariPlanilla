...
CREATE PROCEDURE SP_CrearBoleta
    ...
    @Corte DATE,
    @SalarioBase DECIMAL(18, 2),  -- Agregamos un nuevo par�metro para el salario base
    @DescuentoISSS DECIMAL(18, 2) OUTPUT,  -- Cambiamos a un par�metro de salida para el descuento ISSS
...
BEGIN
    ...
    DECLARE @ExcesoRenta DECIMAL(18, 2) = @SalarioBase - 472.00;  -- L�mite de salario para Renta
...
SP_AgregarUsuario 'NombreUsuario2', 'HashContrase�a2', 'Kotov'
SELECT * FROM Usuarios

DECLARE @UserId INT = 1; -- Reemplaza con el ID del usuario
DECLARE @CodigoEmpleado NVARCHAR(20) = 'E001'; -- Reemplaza con el c�digo del empleado
...
BEGIN
    ...
    -- Obtener el ID de la boleta reci�n insertada
    SET @BoletaId = SCOPE_IDENTITY();

    -- Registrar en el historial de actualizaci�n
